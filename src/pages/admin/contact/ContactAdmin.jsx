...
function Contact() {
    ...
    return (
        <div className="min-h-screen overflow-x-hidden bg-[#f8fafc]">
                        ...
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                            <div className="min-w-0">
                                ...
                                <p className="mt-1 text-xs text-gray-500 sm:text-sm">
                                    Manage and review messages received from your customers.
                                </p>
                            </div>

                            <div className="flex w-full items-center gap-3 rounded-2xl border border-gray-100 bg-white px-4 py-3 shadow-sm sm:w-fit sm:px-5">
                        ...
                        <div className="border-b border-gray-100 p-4 sm:p-6">
                            <div className="relative w-full sm:max-w-md">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-xl border border-gray-200 bg-gray-50 py-3 pl-10 pr-4 text-sm text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-50"
                                />
                            </div>
                        </div>
                            ...
                            <table className="w-full min-w-[1000px]">
                                <thead>
                                    <tr className="border-b border-gray-100 bg-gray-50/80">
                                        ...
                                        <th className="px-4 py-4 text-center text-xs font-bold uppercase tracking-wider text-gray-500 sm:px-5">
                                            Action
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    {currentItems.length === 0 ? (
                                        <tr>
                                            ...
                                            >
                                                <div className="mx-auto flex max-w-sm flex-col items-center">
                                                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gray-100 text-blue-500">
                                                        <FaEnvelopeOpenText size={27} />
                                                    </div>
                                        ...
                                        currentItems.map((contact, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-5 text-sm text-gray-600 sm:px-5">
                                                    {contact.phone}
                                                </td>
                                                ...
                                                <td className="px-4 py-5 sm:px-5">
                                                    <div className="flex justify-center gap-2">
                                                        <button
                                                            ...
                                                            className="rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-xs font-semibold text-blue-600 transition hover:bg-blue-600 hover:text-white sm:px-4"
                                                        >
                                                            View
                                                        </button>
                                                        ...
                                                        <button
                                                            ...
                                                            className="rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-xs font-semibold text-red-600 transition hover:bg-red-600 hover:text-white sm:px-4"
                                                        >
                                                            Delete
                                                        </button>
                                                    </div>
                                        ...
                                        {[...Array(totalPages).keys()].map(
                                            (num) => (
                                                <button
                                                    ...
                                                    className={`h-9 min-w-9 rounded-lg px-2 text-xs font-semibold transition sm:px-3 sm:text-sm ${
                                                        currentPage === num + 1
            ...
            >
                <div className="overflow-hidden rounded-2xl border-0 bg-white shadow-2xl sm:rounded-3xl">
                    <div className="flex items-center justify-between border-b border-gray-100 bg-gray-50 px-4 py-4 sm:px-6 sm:py-5">
                        ...
                        <button
                            ...
                            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-white text-xl text-gray-400 shadow-sm transition hover:bg-gray-100 hover:text-gray-700"
                        >
                            ×
                        </button>
                    </div>

                    <div className="max-h-[75vh] overflow-y-auto px-4 py-6 sm:px-6 sm:py-7">
                        {selectedContact && (
                            <div className="space-y-5">
                                <div className="flex items-center gap-4 rounded-2xl bg-gray-50 p-4">
                                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-blue-100 text-lg font-bold text-blue-600 sm:h-14 sm:w-14">
                                    ...
                                    <div>
                                        ...
                                        <div className="overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 p-2">
                                            <img
                                                ...
                                                alt="User"
                                                className="max-h-[300px] w-full rounded-xl object-contain sm:max-h-[350px]"
                                            />
                                        </div>
                                    </div>
                                )}
                    ...
                    <div className="flex justify-end border-t border-gray-100 bg-gray-50 px-4 py-4 sm:px-6">
                        <Button
                            variant="light"
                            onClick={handleCloseModal}
                            className="w-full rounded-xl border border-gray-200 bg-white px-6 py-2.5 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-100 sm:w-auto"
                        >
                            Close
                        </Button>
                    </div>
